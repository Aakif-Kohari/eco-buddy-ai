...
from household import add_member
from household_activities import log_activity, VALID_CATEGORIES
from household_goals import create_goal
...
def simulate_historical_data(household_id: int, months_back: int = 6, num_members: int = 2) -> bool:
    """Generate realistic historical footprint data for a household.
    
    Args:
        household_id: The household to populate.
        months_back: Number of months to simulate into the past.
        num_members: How many members to ensure exist in the household.
