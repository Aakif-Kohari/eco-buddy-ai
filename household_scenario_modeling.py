...
from household_metrics import calculate_sustainability_score
...
def recommend_top_scenario(household_id: int) -> Optional[Dict[str, Any]]:
    """Determine the single most impactful scenario for a household."""
...
def project_goal_achievement(household_id: int, goal_id: int, scenario_key: str) -> Dict[str, Any]:
    ...
    if impact < 0:
        ...
        return {
            ...
            "reason": f"This scenario does not reduce {metric} emissions."
        }
