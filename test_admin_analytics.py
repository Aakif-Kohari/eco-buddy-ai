...
def test_popular_recommendations_ranking():
    ...
    # Both assessments use Car and high electricity to generate identical recommendations
    mock_assessments = [
    ...
    assert len(recs) > 0
    # Check that counts are integers >= 1 and recommendations are ordered descending
