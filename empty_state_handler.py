...
class EmptyStateMessageGenerator:
    ...
    def _initialize_message_templates(self) -> Dict[EmptyStateType, Dict[str, str]]:
        ...
        return {
            ...
            EmptyStateType.NO_DATA: {
                ...
                "message": "We don't have enough information to provide eco-friendly recommendations. This could be because the product is new or from a less common category.",
            ...
            EmptyStateType.NO_CATEGORY: {
                ...
                "message": "The selected product category doesn't have eco-friendly recommendations yet. We're working on expanding our database.",
            ...
            EmptyStateType.NO_PREFERENCES: {
                ...
                "subtitle": "Customize your preferences to get personalized recommendations."
            },
            EmptyStateType.NO_HISTORY: {
                "title": "No Shopping History",
                "message": "We don't have any shopping history to analyze. Start by logging your purchases to get personalized eco-friendly recommendations.",
            ...
            EmptyStateType.ERROR: {
                ...
                "message": "We encountered an error while fetching your eco-friendly recommendations. Please try again later.",
    ...
    def _initialize_educational_content(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            ...
            "packaging_impact": {
                ...
                "content": "Packaging contributes significantly to environmental pollution and waste. Choosing products with minimal or sustainable packaging can greatly reduce your environmental impact.",
    ...
    def generate_empty_state_config(self, state_type: EmptyStateType, 
        ...
        return EmptyStateConfig(
            ...
            message=template.get("message", "We couldn't find any recommendations."),
        ...
        if context and context.get("category"):
            ...
            if category == "food":
                fallbacks = [
                    ...
                    {"title": "Bulk Buying", "description": "Buy in bulk to reduce packaging waste.", "impact": "Medium"}
                ]
...
class EmptyStateHandler:
    ...
    def handle_empty_state(self, state_type: EmptyStateType, 
        ...
        metadata = {
            ...
            "user_id": user_id,
            "context": context or {},
            "has_fallback": bool(config.fallback_recommendations),
            "has_suggestions": bool(config.suggestions)
        }
...
class EmptyStateRenderer:
    ...
    def render_empty_state(self, state_type: EmptyStateType, 
        ...
        return {
            ...
            "fallback_recommendations": config.fallback_recommendations,
