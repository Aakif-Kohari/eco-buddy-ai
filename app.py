...
from database import init_db, save_assessment, get_assessments, init_gamification_db, init_freeze_tokens_db, init_marketplace_db, init_energy_tracker_db, save_assessment_draft, verify_user, create_user, get_leaderboard, update_user_leaderboard_preference
...
tab1, tab2, tab3, tab4, tab5,tab38, tab6, tab37,tab7, tab8, tab9, tab10, tab11,tab36, tab12, tab13, tab14, tab15, tab16, tab17, tab18, tab19, tab20, tab21, tab22, tab23, tab24,tab34,tab35, tab25,tab26,tab27,tab28,tab29,tab30,tab31,tab32,tab33, tab_email, tab_chat, tab41, tab40, tab39 = st.tabs([
    "🌍 Carbon Footprint",
    "⚡ Home Energy Audit",
    "🎮 Gamification",
