"""
seasonal_eco_recommendations.py
====================================
...
class SeasonalRecommendation:
    """Data class for seasonal recommendations."""
...
class SeasonalRecommendationEngine:
    """
    Main engine for generating seasonal recommendations.
    """
    ...
    def _initialize_recommendations(self) -> Dict[Season, List[SeasonalRecommendation]]:
        """
        Initializes seasonal recommendations.
        ...
        spring_recs = [
            ...
            SeasonalRecommendation(
                ...
                description="Get your bicycle ready for spring and summer commuting to reduce car emissions.",
                season=Season.SPRING,
                priority=RecommendationPriority.MEDIUM,
                impact_level=ImpactLevel.MODERATE,
