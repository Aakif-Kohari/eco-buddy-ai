...
from household_budgeting import evaluate_budgets
from household_activities import VALID_CATEGORIES
...
def create_goal_progress_bullet_chart(goals: List[Dict[str, Any]]) -> go.Figure:
    """Create a bullet chart for multiple active goals."""
    if not goals:
        return _empty_figure("No active goals.")
